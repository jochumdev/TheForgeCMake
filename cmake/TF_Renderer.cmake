...
file(GLOB _SHADERS "${FORGE_UI_SHADERS_DIR}/FSL/*.fsl")
set(FORGE_UI_SHADERS ${_SHADERS} CACHE INTERNAL "")

set(FORGE_TEXT_SHADERS_DIR "${FORGE_COMMON_DIR}/Application/Fonts/Shaders")
file(GLOB _SHADERS "${FORGE_TEXT_SHADERS_DIR}/FSL/*.fsl")
set(FORGE_TEXT_SHADERS ${_SHADERS} CACHE INTERNAL "")

set(FORGE_PANINI_SHADERS_DIR "${FORGE_MIDDLEWARE_DIR}/PaniniProjection/Shaders")
file(GLOB _SHADERS "${FORGE_PANINI_SHADERS_DIR}/FSL/*.fsl")
set(FORGE_PANINI_SHADERS ${_SHADERS} CACHE INTERNAL "")